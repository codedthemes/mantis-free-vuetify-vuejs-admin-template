...
const chartOptions1 = computed(() => {
  return {
    ...
    responsive: [
      { breakpoint: 400, options: { plotOptions: { bar: { columnWidth: '65%' } } } },
      { breakpoint: 450, options: { plotOptions: { bar: { columnWidth: '55%' } } } },
      { breakpoint: 550, options: { plotOptions: { bar: { columnWidth: '45%' } } } },
      { breakpoint: 650, options: { plotOptions: { bar: { columnWidth: '35%' } } } },
      { breakpoint: 768, options: { plotOptions: { bar: { columnWidth: '30%' } } } },
      { breakpoint: 960, options: { plotOptions: { bar: { columnWidth: '30%' } } } },
      { breakpoint: 1150, options: { plotOptions: { bar: { columnWidth: '35%' } } } },
      { breakpoint: 1280, options: { plotOptions: { bar: { columnWidth: '30%' } } } },
      { breakpoint: 1360, options: { plotOptions: { bar: { columnWidth: '35%' } } } }
    ]
  };
});
